...
<body>
	...
	<form class="hi" action="update.do" method=POST>
	<div>
	<input type="text" name="id" hidden value="${login.id}">
	이름
	<input class="hi" type="text" name="name">
	비밀번호
	<input class="hi" type="password" name="pw">
	<br>
	<br>
	<br>
