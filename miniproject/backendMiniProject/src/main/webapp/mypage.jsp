...
<body>
    ...
    <div class="hi">
	<a href="logout.do"><button type="button" class="btn">로그아웃</button></a>
	<hr>
	<a href="./update.jsp"><button type="button" class="btn">회원정보 수정</button></a>
	<hr>
	<a href="./delete.jsp"><button type="button" class="btn">회원 탈퇴</button></a>
	</div>
